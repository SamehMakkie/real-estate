    ...
    <VStack px={48} spacing={16}>
      ...
      <VStack px={20} spacing={10}>
        ...
        <Text
          ...
          textAlign="center"
          color={"gray.600"}>
          Creating Terms of Use is an essential way to protect your company{"'"}
          s legal interests, manage the use of your website or app, and promote
          your business as a professional and trustworthy organization.
        </Text>
      </VStack>
      <VStack spacing={5} alignItems="start">
        <Heading as={"h2"} size="lg">
          About Terms of Use Agreements
        </Heading>
        <Text>
